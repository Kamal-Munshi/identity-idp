class SessionEncryptor
  ...
  def load(value)
    if should_use_legacy_encryptor_for_read?(value)
      return LegacySessionEncryptor.new.load(value)
    end
  ...
  def dump(value)
    if should_use_legacy_encryptor_for_write?
      return LegacySessionEncryptor.new.dump(value)
    end
